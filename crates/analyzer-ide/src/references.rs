//! Find-references: same-file references to the definition under the
//! cursor. Shadowing-aware — each candidate identifier is re-resolved and
//! kept only if it resolves to the same definition.
